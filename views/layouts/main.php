    ...
    if (User::canRoute('/attendee/index')) {
        if (User::hasRole ('desk', false)) {
            ...
            $menuitemsatt = [
                ...
                ['label' => 'Informe - etiquetas - después de impresión', 'url' => '/attendee/reportbadgelabels/A', 'linkOptions' => ['target' => 'blank']],
                ['label' => 'Informe - etiquetas - después de impresión - info tickets', 'url' => '/attendee/reportbadgelabels/A/T', 'linkOptions' => ['target' => 'blank']],
                ['label' => 'Informe - etiquetas - con tarjetas', 'url' => '/attendee/reportbadgelabels/0/B', 'linkOptions' => ['target' => 'blank']],
                ['label' => 'Informe - etiquetas - con tarjetas - después de impresión', 'url' => '/attendee/reportbadgelabels/A/B', 'linkOptions' => ['target' => 'blank']],
                ['label' => 'Informe - etiquetas - sólo niños y pegatinas padres', 'url' => '/attendee/reportbadgelabels/0/C', 'linkOptions' => ['target' => 'blank']],
                ['label' => 'Informe - etiquetas - sólo niños y pegatinas padres - después de impresión', 'url' => '/attendee/reportbadgelabels/A/C', 'linkOptions' => ['target' => 'blank']],
                ...
                ['label' => 'Informe - tickets - después de impresión', 'url' => '/attendee/reporttickets/A', 'linkOptions' => ['target' => 'blank']],
