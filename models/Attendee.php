...
class Attendee extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['idAttendeeRoommate1'], 'exist', 'skipOnError' => true, 'targetClass' => Attendee::className(), 'targetAttribute' => ['idAttendeeRoommate1' => 'cif_attendees.id']],
            [['idAttendeeRoommate2'], 'exist', 'skipOnError' => true, 'targetClass' => Attendee::className(), 'targetAttribute' => ['idAttendeeRoommate2' => 'cif_attendees.id']],
	        [['idAttendeeRoommate3'], 'exist', 'skipOnError' => true, 'targetClass' => Attendee::className(), 'targetAttribute' => ['idAttendeeRoommate3' => 'cif_attendees.id']],
            [['idAttendeeParent'], 'exist', 'skipOnError' => true, 'targetClass' => Attendee::className(), 'targetAttribute' => ['idAttendeeParent' => 'cif_attendees.id']],
